 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\UserController::storeComment
 * @see app/Http/Controllers/UserController.php:120
 * @route '/user/posts/{id}/comments'
 */
export const storeComment = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/user/posts/{id}/comments'
 */
storeComment.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
 ...
 * @route '/user/posts/{id}/comments'
 */
storeComment.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeComment.url(args, options),
    method: 'post',
})
 ...
 * @route '/user/posts/{id}/comments'
 */
    const storeCommentForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/user/posts/{id}/comments'
 */
        storeCommentForm.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeComment.url(args, options),
            method: 'post',
        })
...
/**
* @see \App\Http\Controllers\UserController::destroyComment
 * @see app/Http/Controllers/UserController.php:133
 * @route '/user/posts/{postId}/comments/{commentId}'
 */
export const destroyComment = (args: { postId: string | number, commentId: string | number } | [postId: string | number, commentId: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/user/posts/{postId}/comments/{commentId}'
 */
destroyComment.url = (args: { postId: string | number, commentId: string | number } | [postId: string | number, commentId: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    postId: args[0],
                    commentId: args[1],
 ...
 * @route '/user/posts/{postId}/comments/{commentId}'
 */
destroyComment.delete = (args: { postId: string | number, commentId: string | number } | [postId: string | number, commentId: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyComment.url(args, options),
    method: 'delete',
})
 ...
 * @route '/user/posts/{postId}/comments/{commentId}'
 */
    const destroyCommentForm = (args: { postId: string | number, commentId: string | number } | [postId: string | number, commentId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/user/posts/{postId}/comments/{commentId}'
 */
        destroyCommentForm.delete = (args: { postId: string | number, commentId: string | number } | [postId: string | number, commentId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroyComment.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const UserController = { index, create, store, edit, update, destroy, show, storeComment, destroyComment }
